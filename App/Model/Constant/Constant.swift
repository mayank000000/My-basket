...
public let APP_THEME_COLOR :UIColor = COLOR_CUSTOM(219,33,38,1)//(233,120,47,1)//(244,204,81,1)//(117, 30,208,1)
public let APP_THEME_COLOR2 :UIColor = COLOR_CUSTOM(219,33,38,1)
